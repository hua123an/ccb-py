...
- If the user should choose from specific answers, ALWAYS pass them via the `options` field instead of embedding the choices inside `question`
- Keep `question` short and focused; put the selectable labels in `options`
